...
<div class="page-content container-fluid">
        <form class="form-edit-add" role="form" action="@if(isset($dataTypeContent->id)){{ route('voyager.gioithieus.update', $dataTypeContent->id) }}@else{{ route('voyager.gioithieus.store') }}@endif" method="POST" enctype="multipart/form-data">
